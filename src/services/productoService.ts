...
export class ProductoService {
    ...
    public async actualizarProducto(
        ...
        const producto: any = await this.productoRepo.findById(id);
        if (!producto) {
        ...
        producto.proveedorId = data.proveedorId || "1";
        producto.precioCompra = data.precioCompra || 0;
        producto.precioVenta = data.precioVenta || 0;
        producto.categoria = data.categoria || "";
        producto.proveedorNombre = data.proveedor || "";
    ...
    public async crearProductoEnvasado(
        ...
        const nuevoEnvasado: any = new ProductoEnvasado(
        ...
        nuevoEnvasado.precioCompra = precioCompra;
        nuevoEnvasado.precioVenta = precioVenta;
        nuevoEnvasado.categoria = categoria;
        nuevoEnvasado.proveedorNombre = proveedorNombre;
        nuevoEnvasado.proveedorId = proveedorId;
    ...
    public async crearProductoSuelto(
        ...
        const nuevoSuelto: any = new ProductoSuelto(
            id || Date.now().toString(),
            proveedor,
            nombre,
            oferta,
        ...
        nuevoSuelto.cantidad = cantidad;
        nuevoSuelto.precioCompra = precioCompra;
        nuevoSuelto.precioVenta = precioVenta;
        nuevoSuelto.categoria = categoria;
        nuevoSuelto.proveedorNombre = proveedorNombre;
        nuevoSuelto.proveedorId = proveedorId;
